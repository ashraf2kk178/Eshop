                                ...
                                <table id="datatablesSimple" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>image 2</th>
                                             <th>tags</th>
                                            <th colspan="2" width="30%">Action</th>
                                    ...
                                    <tbody>
                                       @foreach($data as $post)
                                            ...
                                            <tr>
                                             ...
                                             <td>{{$post->title}}</td>
<td><img src="{{ asset('imgs/thumb').'/'.$post->thumb }}" style="width: 45%;"/></td>
<td><img src="{{ asset('imgs/full').'/'.$post->full_img }}" style="width: 45%;"/></td>
                                                 <td>{{$post->tags}}</td>

                                              <td>
<a href="{{url('admin/post/'.$post->id.'/edit')}}" class="btn btn-primary"> Update </a>
<a onclick="return confirm ('Are you sure you want to delete this title')"
 href="{{url('admin/post/'.$post->id.'/delete')}}" class="btn btn-danger"> Delete </a>
                                              </td>
                                            </tr>
