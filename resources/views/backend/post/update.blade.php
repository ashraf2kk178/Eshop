                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <i class="fas fa-table me-1"><a class="btn btn-primary" href="{{url('admin/post')}}" role="button">all Post</a></i>
 ...
 <label for="exampleInputEmail1" class="form-label">category title</label>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="tags" value="{{$data->tags}}">
  </div>
...
<p class="my-2"><img width="80" src="{{asset('imgs/thumb')}}/{{$data->thumb}}"/></p>
     <input type="hidden" name="{{$data->image}}" name="post_thumb">
