                                    ...
                                    <tbody>
                                       @foreach($data as $cat)
                                            <tr>
                                              <td>{{$cat->id}}</td>
                                              <td>{{$cat->title}}</td>
                            <td><img src="{{ asset('imgs').'/'.$cat->image }}" style="width: 40%;"/></td>

                                              <td>
<a href="{{url('admin/category/'.$cat->id.'/edit')}}" class="btn btn-primary"> Update </a>
<a onclick="return confirm ('Are you sure you want to delete this title')"
 href="{{url('admin/category/'.$cat->id.'/delete')}}" class="btn btn-danger"> Delete </a>
                                              </td>
                                            </tr>
                                            @endforeach
